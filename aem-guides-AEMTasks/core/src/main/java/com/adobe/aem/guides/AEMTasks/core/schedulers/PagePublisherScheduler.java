...
public class PagePublisherScheduler implements Runnable {
    ...
    public @interface Config {
        ...
        String pagePath() default "/content/AEMTasks/us/en";
    }
    ...
    public void run() {
        if (enabled) {
            try (ResourceResolver resourceResolver = resolverFactory.getServiceResourceResolver(Map.of(ResourceResolverFactory.SUBSERVICE, "writeService"))) {
