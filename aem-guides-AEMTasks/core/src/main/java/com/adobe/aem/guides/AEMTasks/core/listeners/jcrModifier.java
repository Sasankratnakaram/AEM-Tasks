...
public class jcrModifier implements EventHandler {

    private static final Logger LOG = LoggerFactory.getLogger(jcrModifier.class);
    ...
    private ResourceResolver getResourceResolver() {
        ...
        try {
            ...
            param.put(ResourceResolverFactory.SUBSERVICE, "Sasank");
            resolver = resourceResolverFactory.getServiceResourceResolver(param);
            LOG.info("ResourceResolver obtained for service user 'Sasank'");
        } catch (Exception e) {
